...
spam_wc = WordCloud(background_color="white", contour_color='black',width = 512,height = 512).generate(spam_words)
...
ham_wc = WordCloud(background_color="white", contour_color='black',width = 512,height = 512).generate(ham_words)
plt.figure(figsize = (9, 8))
plt.imshow(ham_wc)
plt.axis('off')
plt.tight_layout(pad = 0)
